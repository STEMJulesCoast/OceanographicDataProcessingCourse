...
def plot_sst_composites_robinson(sst_anom_positive, sst_anom_negative,vmin=-1.5, vmax=1.5):
    """
    ...
    # Plot the positive anomalies (El Niño) with Robinson projection
    ...
    # Plot the negative anomalies (La Niña) with Robinson projection
    ...
    # Add a colorbar
    fig.colorbar(cs2, ax=axes.ravel().tolist(), orientation='horizontal', pad='5%', aspect=50, label='°C')
